...
#print(z, type = 'latex', booktabs = T, caption.placement = "top", add.to.row = list(pos = as.list(rws), command = col), include.rownames=F, comment=F, tabular.environment ='longtable', floating = FALSE, scalebox=1)
```
\end{fullwidth}
